module.exports = {
  ...
  types: [
    {
      value: 'build',
      name: 'build:     Общие правки проекта или изменения внешних зависимостей',
    },
    ...
    {
      value: 'chore',
      name: 'chore:     Общие правки проекта или изменения внешних зависимостей',
    },
  ],

  // Область. Она характеризует фрагмент кода, которую затронули изменения
  scopes: [{ name: 'general' }, { name: 'client' }, { name: 'server' }],
