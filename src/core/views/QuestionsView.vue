  ...
  <v-container fluid style="max-width: 1000px">
    ...
    <v-row no-gutters justify="center" class="mb-8">
      <v-col cols="12" class="col-sm-6">
        <v-sheet elevation="2" rounded dark color="#49494a" class="pa-2">
          <v-text-field label="Поиск" prepend-inner-icon="mdi-magnify" clearable solo-inverted hide-details dense />
        </v-sheet>
      </v-col>
    </v-row>
    ...
    <v-row no-gutters justify="center" class="mb-8">
      <v-col cols="12" class="mb-4">
        <v-tabs
          ...
          centered>
          <v-tab href="#tab-1" style="width: 150px">
            Новые
            <v-icon class="ml-2 ml-sm-0">mdi-new-box</v-icon>
          </v-tab>
          <v-tab href="#tab-2" style="width: 150px">
            В фокусе
            <v-icon class="ml-2 ml-sm-0">mdi-crosshairs-question</v-icon>
          </v-tab>
          <v-tab href="#tab-3" style="width: 150px">
            Отвеченные
